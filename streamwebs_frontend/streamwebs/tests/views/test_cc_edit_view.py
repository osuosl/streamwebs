    ...
    def test_view_with_good_data(self):
        ...
        response = self.client.post(
            reverse(
                ...
                'canopy_cover-0-Y': False,
                'canopy_cover-0-Z': True,
                ...
                'canopy_cover-1-Y': False,
                'canopy_cover-1-Z': True,
                ...
                'canopy_cover-2-Y': False,
                'canopy_cover-2-Z': True,
                ...
                'canopy_cover-3-X': False,
                'canopy_cover-3-Y': True,
                'canopy_cover-3-Z': False
               }
            )
