...
class RipAquaSurveyTestCase(TestCase):
    ...
    def test_datasheet_ManyToOneSite(self):
        ...
        plant_1 = Rip_Aqua_Survey_Plants.objects.create_sample("cactus1",
                                                               "not really")
        plant_2 = Rip_Aqua_Survey_Plants.objects.create_sample("cactus2",
                                                               "dope")
        plant_3 = Rip_Aqua_Survey_Plants.objects.create_sample("cactus3",
                                                               "asdfasdf")
        plant_4 = Rip_Aqua_Survey_Plants.objects.create_sample("cactus4",
                                                               "sorta")
        plant_5 = Rip_Aqua_Survey_Plants.objects.create_sample("cactus5",
                                                               "kinda")
        plant_6 = Rip_Aqua_Survey_Plants.objects.create_sample("cactus6",
                                                               "catchemall")

        wl_1 = Rip_Aqua_Survey_Wildlife.objects.create_sample("dog", "4")
        wl_2 = Rip_Aqua_Survey_Wildlife.objects.create_sample("dog1", "4")
        wl_3 = Rip_Aqua_Survey_Wildlife.objects.create_sample("dog2", "2")
        wl_4 = Rip_Aqua_Survey_Wildlife.objects.create_sample("dog3", "4")
        wl_5 = Rip_Aqua_Survey_Wildlife.objects.create_sample("dog4", "3")
        wl_6 = Rip_Aqua_Survey_Wildlife.objects.create_sample("dog5", "1")
    ...
    def test_datasheet_RequiredFields(self):
        ...
        wl_1 = Rip_Aqua_Survey_Wildlife.objects.create_sample("dog",
                                                              "not really")
        wl_2 = Rip_Aqua_Survey_Wildlife.objects.create_sample("dog1",
                                                              "not really")
    ...
    def test_datasheet_OptionalFields(self):
        ...
        # Assert that the optional fields for each of the 2 plant
        # identification and 2 wildlife identifications are for the datasheet
