...
from streamwebs.models import RiparianTransect, Site, School, validate_slope
...
class RiparianTransectTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.school = School.test_objects.create_school('School of Cool')
    ...
    def test_validate_slope_good(self):
        ...
        transect = RiparianTransect.test_objects.create_transect(
            self.school, '2016-07-11 14:09', site, 'Cloudy, no meatballs',
    ...
    def test_Transect_ManyToOneSite(self):
        ...
        transect = RiparianTransect.test_objects.create_transect(
            self.school, '2016-07-11 14:09', self.site)
    ...
    def test_transect_creation_req_fields(self):
        ...
        # Required
        self.assertEqual(transect.school.name, 'School of Cool')
